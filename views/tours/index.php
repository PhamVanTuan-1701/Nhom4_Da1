...
<div class="row mb-4 align-items-center">
    ...
    <div class="col-6 text-end">
        <a href="<?= BASE_URL ?>tour/create" class="btn btn-success">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 shadow-sm border-0">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="<?= BASE_URL ?>tour/edit?id=<?= $tour['id'] ?>">
                                    <i class="bi bi-pencil-square text-warning me-2"></i>Sửa thông tin
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item text-danger" href="<?= BASE_URL ?>tour/delete?id=<?= $tour['id'] ?>" onclick="return confirm('Xóa tour này sẽ mất vĩnh viễn?')">
                ...
                <a href="<?= BASE_URL ?>tour-detail?id=<?= $tour['id'] ?>" class="btn btn-primary w-100 py-2">
